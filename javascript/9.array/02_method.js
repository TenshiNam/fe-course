...
// for(let number of numbers) {  //0:1,1:2, 
//     console.log(`number = ${number}`);    
// }
// for(let fruit of fruits) {  //0:1,1:2, 
...
//요소 삭제
console.log('fruits.splice(0, 2) = ', fruits.splice(0, 2)); 
console.log(fruits);
...
//삭제하지 않고 요소 추가
console.log('fruits.splice(0, 0, 교체아이템) = ', 
            fruits.splice(0, 0, '🍅')); //요소 삭제 후 교체
console.log(fruits);
